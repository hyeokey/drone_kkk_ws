...
#include "drone_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = drone_msgs__msg__Waypoint;
...
size_t get_serialized_size_drone_msgs__msg__Waypoint(
  const void * untyped_ros_message,
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_msgs__msg__Waypoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drone_msgs
size_t max_serialized_size_drone_msgs__msg__Waypoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_msgs__msg__Waypoint;
    is_plain =
      (
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_msgs__msg__Waypoint(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_msgs, msg, Waypoint)() {
