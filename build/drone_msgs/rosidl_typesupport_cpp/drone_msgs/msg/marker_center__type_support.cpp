...
static const _MarkerCenter_type_support_symbol_names_t _MarkerCenter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drone_msgs, msg, MarkerCenter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drone_msgs, msg, MarkerCenter)),
  }
};
...
{
  return &::drone_msgs::msg::rosidl_typesupport_cpp::MarkerCenter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, drone_msgs, msg, MarkerCenter)() {
  return get_message_type_support_handle<drone_msgs::msg::MarkerCenter>();
}
