...
#include "px4/msg/detail/gain_compression__rosidl_typesupport_fastrtps_c.h"
...
using _GainCompression__ros_msg_type = px4__msg__GainCompression;
...
size_t get_serialized_size_px4__msg__GainCompression(
  const void * untyped_ros_message,
...
static uint32_t _GainCompression__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4__msg__GainCompression(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4
size_t max_serialized_size_px4__msg__GainCompression(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4__msg__GainCompression;
    is_plain =
      (
...
static size_t _GainCompression__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_px4__msg__GainCompression(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4, msg, GainCompression)() {
