...
{
public:
  explicit Init_ConfigOverrides_disable_auto_set_home(::px4::msg::ConfigOverrides & msg)
  : msg_(msg)
  {}
  Init_ConfigOverrides_source_type disable_auto_set_home(::px4::msg::ConfigOverrides::_disable_auto_set_home_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ConfigOverrides_disable_auto_set_home defer_failsafes_timeout_s(::px4::msg::ConfigOverrides::_defer_failsafes_timeout_s_type arg)
  {
