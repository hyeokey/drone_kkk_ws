...
#ifndef PX4__MSG__DETAIL__DEVICE_INFORMATION__TRAITS_HPP_
#define PX4__MSG__DETAIL__DEVICE_INFORMATION__TRAITS_HPP_
...
inline void to_yaml(
  const px4::msg::DeviceInformation & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const px4::msg::DeviceInformation & msg)
{
  return px4::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4::msg::DeviceInformation>()
{
  return "px4::msg::DeviceInformation";
}

template<>
inline const char * name<px4::msg::DeviceInformation>()
{
  return "px4/msg/DeviceInformation";
}

template<>
struct has_fixed_size<px4::msg::DeviceInformation>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4::msg::DeviceInformation>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4::msg::DeviceInformation>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4__MSG__DETAIL__DEVICE_INFORMATION__TRAITS_HPP_
