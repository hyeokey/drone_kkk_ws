...
enum
{
  px4__msg__SensorGps__JAMMING_STATE_MITIGATED = 2
};

/// Constant 'JAMMING_STATE_DETECTED'.
enum
{
  px4__msg__SensorGps__JAMMING_STATE_DETECTED = 3
};
...
enum
{
  px4__msg__SensorGps__SPOOFING_STATE_OK = 1
};

/// Constant 'SPOOFING_STATE_MITIGATED'.
enum
{
  px4__msg__SensorGps__SPOOFING_STATE_MITIGATED = 2
};

/// Constant 'SPOOFING_STATE_DETECTED'.
enum
{
  px4__msg__SensorGps__SPOOFING_STATE_DETECTED = 3
};
...
enum
{
  px4__msg__SensorGps__AUTHENTICATION_STATE_UNKNOWN = 0
};

/// Constant 'AUTHENTICATION_STATE_INITIALIZING'.
enum
{
  px4__msg__SensorGps__AUTHENTICATION_STATE_INITIALIZING = 1
};

/// Constant 'AUTHENTICATION_STATE_ERROR'.
enum
{
  px4__msg__SensorGps__AUTHENTICATION_STATE_ERROR = 2
};

/// Constant 'AUTHENTICATION_STATE_OK'.
enum
{
  px4__msg__SensorGps__AUTHENTICATION_STATE_OK = 3
};

/// Constant 'AUTHENTICATION_STATE_DISABLED'.
enum
{
  px4__msg__SensorGps__AUTHENTICATION_STATE_DISABLED = 4
};
...
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_OK = 0ul
};

/// Constant 'SYSTEM_ERROR_INCOMING_CORRECTIONS'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_INCOMING_CORRECTIONS = 1ul
};

/// Constant 'SYSTEM_ERROR_CONFIGURATION'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_CONFIGURATION = 2ul
};

/// Constant 'SYSTEM_ERROR_SOFTWARE'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_SOFTWARE = 4ul
};

/// Constant 'SYSTEM_ERROR_ANTENNA'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_ANTENNA = 8ul
};

/// Constant 'SYSTEM_ERROR_EVENT_CONGESTION'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_EVENT_CONGESTION = 16ul
};

/// Constant 'SYSTEM_ERROR_CPU_OVERLOAD'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_CPU_OVERLOAD = 32ul
};

/// Constant 'SYSTEM_ERROR_OUTPUT_CONGESTION'.
enum
{
  px4__msg__SensorGps__SYSTEM_ERROR_OUTPUT_CONGESTION = 64ul
};
