...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_AUTOTUNE_ENABLE = 212
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_EXTERNAL_ATTITUDE_ESTIMATE = 620
};
...
enum
{
  px4__msg__VehicleCommand__VEHICLE_CMD_DO_SET_SAFETY_SWITCH_STATE = 5300
};
...
enum
{
  px4__msg__VehicleCommand__SAFETY_OFF = 0
};

/// Constant 'SAFETY_ON'.
enum
{
  px4__msg__VehicleCommand__SAFETY_ON = 1
};
