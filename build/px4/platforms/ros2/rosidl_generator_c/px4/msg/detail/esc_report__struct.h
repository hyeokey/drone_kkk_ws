...
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR1 = 101
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR2'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR2 = 102
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR3'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR3 = 103
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR4'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR4 = 104
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR5'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR5 = 105
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR6'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR6 = 106
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR7'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR7 = 107
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR8'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR8 = 108
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR9'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR9 = 109
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR10'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR10 = 110
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR11'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR11 = 111
};

/// Constant 'ACTUATOR_FUNCTION_MOTOR12'.
enum
{
  px4__msg__EscReport__ACTUATOR_FUNCTION_MOTOR12 = 112
};
