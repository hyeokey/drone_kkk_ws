...
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_LANDING = 6
};

/// Constant 'ARM_DISARM_REASON_PREFLIGHT_INACTION'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_PREFLIGHT_INACTION = 7
};

/// Constant 'ARM_DISARM_REASON_KILL_SWITCH'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_KILL_SWITCH = 8
};

/// Constant 'ARM_DISARM_REASON_RC_BUTTON'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_RC_BUTTON = 13
};

/// Constant 'ARM_DISARM_REASON_FAILSAFE'.
enum
{
  px4__msg__VehicleStatus__ARM_DISARM_REASON_FAILSAFE = 14
};
...
enum
{
  px4__msg__VehicleStatus__NAVIGATION_STATE_ALTITUDE_CRUISE = 8
};
