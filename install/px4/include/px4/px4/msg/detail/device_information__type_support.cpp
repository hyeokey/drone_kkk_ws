...
{
  new (message_memory) px4::msg::DeviceInformation(_init);
}

void DeviceInformation_fini_function(void * message_memory)
{
  auto typed_message = static_cast<px4::msg::DeviceInformation *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DeviceInformation_message_member_array[8] = {
  {
    ...
    offsetof(px4::msg::DeviceInformation, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, device_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, vendor_name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    32,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, model_name),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, device_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    24,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, firmware_version),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    24,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, hardware_version),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    33,  // array size
    false,  // is upper bound
    offsetof(px4::msg::DeviceInformation, serial_number),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DeviceInformation_message_members = {
  ...
  8,  // number of fields
  sizeof(px4::msg::DeviceInformation),
...
get_message_type_support_handle<px4::msg::DeviceInformation>()
{
  return &::px4::msg::rosidl_typesupport_introspection_cpp::DeviceInformation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, DeviceInformation)() {
  return &::px4::msg::rosidl_typesupport_introspection_cpp::DeviceInformation_message_type_support_handle;
}
